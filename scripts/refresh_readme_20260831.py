...
old_public = """The public playground gives you several doors into the same architecture:
...
"""
new_public = """The public playground now opens with a **Visual Logical Robot** and gives you five doors into the same QCDS / Syntract architecture:
...
"""
replace_once(old_public, new_public, "public surface")

visual_anchor = """See [`LIVING_LOGICAL_ROBOT.md`](LIVING_LOGICAL_ROBOT.md).

---

## The Living Logical Space
"""
visual_section = """See [`LIVING_LOGICAL_ROBOT.md`](LIVING_LOGICAL_ROBOT.md).
...
## The Living Logical Space
"""
replace_once(visual_anchor, visual_section, "visual logical robot section")

system_anchor = """WebAssembly is an execution substrate for the packaged Python core, not a client-side rewrite of QCDS.

---

## Oracle-space topology: session, external and central
"""
system_section = """WebAssembly is an execution substrate for the packaged Python core, not a client-side rewrite of QCDS.
...
## Oracle-space topology: session, external and central
"""
replace_once(system_anchor, system_section, "SyntractSystem section")

parallel_anchor = "## Browser-scale execution, QCDS-driven swarm and central fabric\n"
parallel_section = """## Parallel Syntract composition
...
"""
replace_once(old_central, new_central, "threadless central fabric")

verifiable_anchor = "- explicit emulation-projection provenance showing which active praxis dimensions were executed or projected out while Quantum Full Space remains unaffected.\n"
verifiable_new = """- explicit emulation-projection provenance showing which active praxis dimensions were executed or projected out while Quantum Full Space remains unaffected;
...
"""
replace_once(verifiable_anchor, verifiable_new, "verifiable list")

guide_anchor = """| `src/qcds_fabric/problem.py` | problem → QCDS → Syntract path |
| `src/qcds_fabric/fabric.py` | Fabric layer and rotation/stabilization boundary |
"""
guide_new = """| `src/qcds_fabric/problem.py` | problem → QCDS → Syntract path |
...
"""
replace_once(guide_anchor, guide_new, "repository guide")

path.write_text(text, encoding="utf-8")
print("README refresh prepared")
