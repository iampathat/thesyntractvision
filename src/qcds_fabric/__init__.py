...
__all__ = [
    ...
    "run_oracle_genesis_cycle", "DistributionStabilizer", "FabricLayer",
    "NullBankResult", "RotationBankResult", "StabilizedRotationSuiteResult",
    "BoundCondition", "FunnelLayerResult", "FunnelTrace", "funnel_step",
    "recursive_contraction_funnel", "ReentryCompilation", "ReentryResult",
    "compile_bound_condition", "run_bound_condition_reentry",
    "baseline_reentry_distribution", "ConvergenceConfig", "ConvergenceSnapshot",
    "RecursiveCycleTrace", "RecursiveFabricTrace", "RecursiveFabricResult",
    "RecursiveFabricEngine", "automatic_contraction_widths", "compare_truth_distributions",
    "SlotBias", "OracleExposureBias", "InjectedBiasKernel", "BenchmarkMetrics",
    "AblationVariant", "AblationResult", "BenchmarkReport", "ContradictionProbe",
