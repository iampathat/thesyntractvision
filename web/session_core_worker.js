/* Transport only. QCDS, Syntract composition, Pick a World and legal inference remain in the packaged Python core. */
let coreReady = null;
...
self.onmessage = async (event) => {
  ...
  try {
    ...
    if (msg.type !== 'run' && msg.type !== 'pick_world_run' && msg.type !== 'legal_run' && msg.type !== 'legal_question_run' && msg.type !== 'syntract_demo_run') return;
