/* Transport only. QCDS, Syntract composition and legal inference remain in the packaged Python core. */
let coreReady = null;
...
self.onmessage = async (event) => {
  ...
  try {
    ...
    if (msg.type !== 'run' && msg.type !== 'legal_run' && msg.type !== 'legal_question_run' && msg.type !== 'syntract_demo_run') return;
    ...
    let expression;
    if (msg.type === 'legal_run') expression = "run_swedish_housing_case_json(__payload_json)";
